...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .search-box { background: #141414; border: 1px solid #2a2a2a; border-radius: 16px; padding: 40px; max-width: 600px; margin: 0 auto; }
        .search-box input { width: 100%; background: #0A0A0A; border: 2px solid #2a2a2a; border-radius: 10px; padding: 16px 20px; color: #fff; font-size: 18px; font-family: 'Rajdhani', sans-serif; letter-spacing: 2px; margin-bottom: 16px; transition: border-color 0.2s; }
        ...
        .error { background: #2a0a0a; border: 1px solid #ff3d00; color: #ff6b6b; padding: 12px 16px; border-radius: 8px; margin-bottom: 16px; font-size: 14px; }
        ...
        .brand-grid { display: flex; flex-wrap: wrap; justify-content: center; gap: 12px; max-width: 800px; margin: 0 auto; }
...
<div class="hero">
    ...
    <p>Enter your radio serial number and get your unlock code in seconds.</p>
    <div class="search-box">
        ...
        <form action="{{ route('search') }}" method="POST">
            @csrf
            <input type="text" name="serial" placeholder="Enter serial number (e.g. AR670WA8078340)" value="{{ old('serial') }}" autocomplete="off" required>
