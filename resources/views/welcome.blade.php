...
<script>
    (() => {
        ...
        const familyLabels = {
            ...
            delco_gm: 'Delco/GM serial detected',
            grundig_opel_gm: 'Grundig Opel/GM serial detected',
            gm_pending: 'GM serial family detected',
            vag: 'VAG serial detected',
            grundig_fiat: 'Grundig Fiat serial detected',
            grundig_legacy: 'Grundig serial detected',
            philips_fiat: 'Philips Fiat serial detected',
            philips_legacy: 'Philips serial detected',
